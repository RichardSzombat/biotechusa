                            ...
                            <div class="col-6">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade" id="description_en" role="tabpanel"
                                        ...
                                        <textarea name="lang[2]" id="en" cols="70" rows="5">{{$description['en'] ?? ""}}</textarea>
                                    </div>
                                    <div class="tab-pane fade" id="description_de" role="tabpanel"
                                         aria-labelledby="contact-tab">
                                        <textarea name="lang[3]" id="de" cols="70" rows="5">{{$description['de'] ?? ""}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <br>
                                    <input class="col-5 datepicker" name="publish_start" type="date" id="publish_start" value="{{$product->publish_start ?? "" }}"> -
                                    <input class="col-5 datepicker" name="publish_end" type="date" id="publish_end"  value="{{$product->publish_end ?? "" }}">
                                </div>
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input type="number" name="price" class="form-control col-4 ml-2" value="{{$product->price ?? ''}}" required>
